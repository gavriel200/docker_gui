...
# ---------------- menu buttons -------------------------------------------------- #
    ...
    def images_page(self):
        ...
        try:
            ...
            pass
        self.add_main_frame_img(self.top_frame)
        # -------- add scrollbar -------- #
    ...
    def containers_page(self):
        ...
        try:
            ...
            pass
        self.add_main_frame_cont(self.top_frame)
        # -------- add scrollbar -------- #
        self.scrollbar_images = Make_scrollbar(scrollbar_frame, 485, 443, "#0e1733", "#0e1733")
...
# ---------------- other functions ----------------------------------------------- #
    ...
    @staticmethod
    def add_main_frame_img(top_frame):
        global main_frame
    ...
    @staticmethod
    def add_main_frame_cont(top_frame):
        global main_frame
        global scrollbar_frame
        main_frame = Frame(top_frame, width=500, height=550, bg="#0e1733")
        main_frame.pack()
        ...
        #this is an invisble label to pulldown the main frame
        Label(main_frame, height=6, bg="#0e1733", borderwidth=0).grid(row=0,column=0)
